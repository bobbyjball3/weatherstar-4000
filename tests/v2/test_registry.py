...
from weatherstar_4000.v2 import PluginNotFound
from weatherstar_4000.v2.plugin import Plugin
from weatherstar_4000.v2.registry import PluginRegistry, plugin, registry
...
def test_load_builtins_is_idempotent():
    from weatherstar_4000.v2.registry import load_builtins
