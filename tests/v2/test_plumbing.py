...
from weatherstar_4000.v2.context import AppContext, DataRegistry
...
def test_select_sequence_requires_name():
    from weatherstar_4000.v2 import ConfigError
...
def test_get_sequence_missing_raises():
    from weatherstar_4000.v2 import SequenceError
    from weatherstar_4000.v2.config_file import AppConfig
...
def test_sequence_from_raw_forms():
    from weatherstar_4000.v2 import SequenceError
    from weatherstar_4000.v2.sequence import Sequence, Slide
...
def test_fonts_fallback_without_asset_fonts(pygame_env, tmp_path):
    from weatherstar_4000.v2.media.fonts import Fonts
...
def test_backgrounds_generates_default_gradient(screen):
    from weatherstar_4000.v2.media.backgrounds import Backgrounds, make_default_background
...
def test_cli_generate_config_nested_output(tmp_path, capsys):
    from weatherstar_4000.v2.cli import main
...
def test_cli_keyboard_interrupt_returns_130(tmp_path, monkeypatch, capsys):
    from weatherstar_4000.v2 import cli
    ...
    import weatherstar_4000.v2.engine as engine_mod
