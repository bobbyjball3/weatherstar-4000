...
class FontCache:
    ...
    @classmethod
    def get_font(cls, font_path: str | None, size: int, bold: bool = False) -> pygame.font.Font:
...
class ImageCache:
    ...
    def load_image(self, path: str, scale: tuple | None = None) -> pygame.Surface | None:
