...
installing an entry point in the ``weatherstar4000.plugins`` group whose
...
from weatherstar_4000.errors import PluginNotFound

if TYPE_CHECKING:
    from weatherstar_4000.plugin import Plugin

ENTRY_POINT_GROUP = "weatherstar4000.plugins"
BUILTIN_PACKAGE = "weatherstar_4000.plugins"
