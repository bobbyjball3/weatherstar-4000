...
``v2.plugins`` imports every built-in module so their registration side effects
run.  External packages can register additional plugins by installing an entry
point in the ``weatherstar4000.plugins`` group whose module self-registers.
"""
...
from weatherstar_4000.v2.errors import PluginNotFound

if TYPE_CHECKING:
    from weatherstar_4000.v2.plugin import Plugin

ENTRY_POINT_GROUP = "weatherstar4000.plugins"
BUILTIN_PACKAGE = "weatherstar_4000.v2.plugins"
