...
from weatherstar_4000.v2.errors import ConfigError
from weatherstar_4000.v2.logging_setup import get_logger
from weatherstar_4000.v2.registry import discover, registry
...
class Builder:
    ...
    def __init__(self, appcfg: AppConfig):
        self.appcfg = appcfg
        self.log = get_logger("weatherstar4000.v2.engine")
...
def run_sequence(
    ...
    *,
    ...
    from weatherstar_4000.v2.ticker import BottomTicker
