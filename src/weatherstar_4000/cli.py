"""Command-line entrypoint for the WeatherStar 4000 engine.

Usage::

    weatherstar4000 [--config PATH] [--sequence NAME] [--lat F] [--lon F]
                       [--log-level LEVEL] [--log-file PATH] [--no-console]
                       [--validate] [--frames N]
    weatherstar4000 generate-config [--sequence NAME] [-o PATH]
...
from weatherstar_4000 import engine
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="weatherstar4000")
...
def _generate_config(args: argparse.Namespace) -> int:
    from weatherstar_4000 import skeleton
...
def _run(args: argparse.Namespace) -> int:
    ...
    from weatherstar_4000.logging_setup import setup_logging
