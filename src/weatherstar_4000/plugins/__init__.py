"""Built-in plugin modules for the WeatherStar 4000.
...
_MODULE_BAGS = (
    "weatherstar_4000.screens",
    "weatherstar_4000.components",
    "weatherstar_4000.datasources",
    "weatherstar_4000.media",
    "weatherstar_4000.sequences",
)
