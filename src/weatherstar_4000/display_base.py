...
class DisplayBase:
    ...
    def _load_background(self, bg_name: str) -> pygame.Surface | None:
    ...
    def draw_header(self, title_top: str, title_bottom: str | None = None, has_noaa: bool = False):
    ...
    def _load_weather_icon(self, condition: str) -> pygame.Surface | None:
