...
The Weather Star 3000 calls this "Forecast Across The Region": a City / Weather /
...
has no classic Weather Star 4000 equivalent, so the classic look is the same
...
from weatherstar.datasources.noaa import RegionalForecast
